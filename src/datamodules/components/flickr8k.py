...
class Vocabulary:
    ...
    def build_vocabulary(self, sentence_list):
        """> For each word in each sentence in the list of sentences, if the word is not in the
        dictionary, add it to the dictionary with a value of 1. If the word is already in the
        dictionary, increment its value by 1. If the word's value is equal to the frequency
        threshold, add it to the itos and stoi dictionaries.
